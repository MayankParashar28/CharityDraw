  ...
  return (
    <div className="fixed inset-0 z-[100] skeuo-base flex flex-col items-center justify-center p-4">
      ...
      <div className={`skeuo-card max-w-sm w-full p-2 rounded-3xl transition-transform duration-300 ${error ? 'animate-bounce' : ''}`}>
        <div className="skeuo-inset rounded-2xl p-6 sm:p-10 flex flex-col items-center border border-white/20">
          ...
          <h2 className="text-lg sm:text-2xl font-black skeuo-text-emboss mb-2 text-center uppercase tracking-widest">Master Override</h2>
          ...
          <form onSubmit={handleUnlock} className="w-full space-y-6">
            <input 
              ...
              className="w-full text-center text-xl sm:text-3xl tracking-[0.3em] sm:tracking-[0.5em] font-black text-gray-700 skeuo-inset py-4 rounded-xl outline-none focus:ring-2 focus:ring-red-400/50 bg-transparent border-none placeholder:text-gray-300 transition-all"
              placeholder="••••"
              autoFocus
            />
